 ...
 */
template <class T>
Collections::LifetimeList<T>::Iterator::Iterator(LifetimeList<T>& lst): current(lst.root)
{
}
 ...
 */
template <class T>
typename Collections::LifetimeList<T>::Iterator& Collections::LifetimeList<T>::Iterator::operator++()
{
    if (current != nullptr) {
